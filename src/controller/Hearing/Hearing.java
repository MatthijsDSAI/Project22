...
public class Hearing {
    public static ArrayList<Tile> computeHearingTiles(Map map, Agent agent) {

        int d = Scenario.config.getDistanceHearingWalk();
        int ds = Scenario.config.getDistanceHearingSprint();
